...
function rewriteHTML(html, baseUrl) {
  ...
  var earlyScript = '<script>(function(){console.log("[Proxy] Starting intercept");var PROXY_ORIGIN="' + proxyOrigin + '";var PROXY_PATH="' + PROXY_PATH + '";function encodeProxyUrl(u){return PROXY_ORIGIN+PROXY_PATH+btoa(u).replace(/\\+/g,"-").replace(/\\//g,"_").replace(/=/g,"")}var OrigXHR=window.XMLHttpRequest;window.XMLHttpRequest=function(){var xhr=new OrigXHR();var origOpen=xhr.open;xhr.open=function(m,u,a,us,p){if(typeof u==="string"&&(u.includes("api.x.com")||u.includes("x.com/i/")||u.includes("graphql"))){console.log("[Proxy] XHR Intercepted:",u.substring(0,80));var pu=encodeProxyUrl(u);console.log("[Proxy] Proxied to:",pu.substring(0,80));return origOpen.call(this,m,pu,a,us,p)}return origOpen.call(this,m,u,a,us,p)};return xhr};var origFetch=window.fetch;window.fetch=function(r,o){var u=typeof r==="string"?r:(r.url||r);if(u&&(u.includes("api.x.com")||u.includes("x.com/i/")||u.includes("graphql"))){console.log("[Proxy] Fetch intercepted:",u.substring(0,80));var pu=encodeProxyUrl(u);if(typeof r==="string"){return origFetch(pu,o)}else{var clonedHeaders=new Headers(r.headers||{});var nr=new Request(pu,{method:r.method||"GET",headers:clonedHeaders,body:r.body,mode:"cors",credentials:"include"});return origFetch(nr,o)}}return origFetch(r,o)};console.log("[Proxy] Intercept OK")})();</script>';
